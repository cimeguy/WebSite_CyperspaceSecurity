...
function skip_with_alert($url,$str){
$html=<<<A
	<!DOCTYPE html>
	<html lang="zh-CN">
	<head>
...
function back_with_alert($url,$str,$id){
$html=<<<A
	<!DOCTYPE html>
	<html lang="zh-CN">
	<head>
	...
	<meta http-equiv="refresh" content="0.001;URL={$url}?back_id={$id}" />
	</body>
	</html>
A;
echo $html;
