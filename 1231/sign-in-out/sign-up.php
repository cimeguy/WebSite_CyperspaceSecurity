			...
			<div class="row">
				<div class="col-md-4">
					...
					<form action="#" class="fh5co-form animate-box" data-animate-effect="fadeInLeft">
						...
						<div class="form-group">
							<label for="email" class="sr-only">学号</label>
							<input type="email" class="form-control" id="email" placeholder="学号" autocomplete="off">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="password" class="form-control" id="re-password" placeholder="重新输入密码" autocomplete="off">
						</div>
						
						<div class="form-group">
							<p>已经注册？ <a href="sign-in.html">登录</a></p>
