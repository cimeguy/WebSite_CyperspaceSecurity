...
$get_wno = isset($_GET["show_wno"]) ? intval($_GET["show_wno"]) : '';
echo '获取的是：';
echo $get_wno;
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">作业详情：
                            <?php
                            echo $name; ?>
                        </h4> </div>
                        <ol class="breadcrumb">
                            <li><a href="tea_homework.php">
                           			 返回
                            	</a>
                            </li>
                                ...
                                <div class="col-sm-12">
                                    <div class="white-box">
                                        <section id="spinner">
                                            ...
                                            <div class="alert alert-success">{$qtitle} </div>
                                            <div class="row icon-list-demo">
                                                <div class="col-12 col-lg-12">
                                                    <div class="contact-form">
                                                        <div class="ABCD">{$this_A}</div>
                                                        <div class="ABCD">{$this_B}</div>
                                                        <div class="ABCD">{$this_C}</div>
                                                        <div class="ABCD">{$this_D}</div>
                                                        <br/>
                                                        <div class="key">{$qkey}</div>
                                                    </div><!-- .contact-form -->
                                                </div><!-- .col -->      
                                            </div>
                                        </section>
